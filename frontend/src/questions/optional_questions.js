...
// - otherTextId: string (for mc/cata questions with an "Other" option)
// - otherPlaceholder: string (optional placeholder for the Other text input)
//
// Optional questions only (per question_design.txt).
// "Other" handling: otherTextId triggers an inline text input in QuestionRenderer.
//
...
export const optionAOptional = [
  ...
  },
  {
    ...
    type: "num",
    label:
      "20. How much are you (or your group) willing to spend? If you're not sure, feel free to leave this blank. ($1–$100,000)",
  ...
  },
  {
    ...
    otherTextId: "cuisines_other",
    otherPlaceholder: "Enter other cuisine(s)...",
  },
  {
  ...
  },
  {
    ...
    otherTextId: "shopping_items_other",
    otherPlaceholder: "Enter other item type(s)...",
  },
  {
    id: "trip_purpose",
    type: "oe",
  ...
  },
  {
    ...
    otherTextId: "start_time_other",
    otherPlaceholder: "Enter preferred start time...",
  },
  {
    id: "return_time",
    type: "mc",
    ...
    otherTextId: "return_time_other",
    otherPlaceholder: "Enter preferred return time...",
  },
  {
    id: "anything_else",
    type: "oe",
...
export const optionBOptional = [
  ...
  },
  {
    ...
    type: "num",
    label:
      "11. How much are you (or your group) willing to spend? If you're not sure, feel free to leave this blank. ($1–$100,000)",
  ...
  },
  {
    ...
    otherTextId: "shopping_items_other_b",
    otherPlaceholder: "Enter other item type(s)...",
  },
  {
    id: "trip_purpose_b",
  ...
  },
  {
    ...
    options: ["7 AM", "8 AM", "9 AM", "10 AM", "11 AM", "12 PM", "Other"],
    otherTextId: "start_time_other_b",
    otherPlaceholder: "Enter preferred start time...",
  },
  {
    id: "return_time_b",
    ...
    otherTextId: "return_time_other_b",
    otherPlaceholder: "Enter preferred return time...",
  },
  {
    id: "anything_else_b",
